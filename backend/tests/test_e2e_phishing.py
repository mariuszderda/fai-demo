"""End-to-end phishing scenario test."""
...
def test_e2e_phishing() -> None:
    """Run the phishing playbook end to end in stub mode."""
    settings = get_settings_cached()
    settings.use_stub_llm = True
    settings.approval_ttl_seconds = 5

    with TestClient(app) as client:
        response = client.post("/api/v1/incidents", json={"scenario": "phishing"})
